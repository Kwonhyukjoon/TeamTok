...
public class CommentAdapter extends BaseAdapter {
    ...
    public CommentAdapter(Context mContext, ArrayList<CommentReq> commentReqArrayList) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        board_id = commentReq.getBoard_id();
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("예", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int i) {
                        ...
                        CommentReq id = new CommentReq(cmt_no, board_id);
                        ...
                        Call<CommentRes> call = commentApi.deleteComment("Bearer " + token, id);
        ...
        upComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.i("AAA" , "!@#!@#@!#!@#"+before_comment + "," + cmt_no);
                uptxt.setText(before_comment);
                builder.setPositiveButton("YES",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                String comment = uptxt.getText().toString().trim();
                                CommentReq commentReq = new CommentReq(cmt_no , board_id , comment);
                                ...
                                Call<CommentRes> call = commentApi.updateComment("Bearer " + token , commentReq);
                                call.enqueue(new Callback<CommentRes>() {
                                    @Override
                                    public void onResponse(Call<CommentRes> call, Response<CommentRes> response) {
